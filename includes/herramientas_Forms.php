...
herramientas_id = ".$her."");
	...
	if($activity == 1){	
		...
		echo'Preguntas cuya respuesta debe seleccionarse de una serie de opciones. <br>';
	    echo '<br>Incluir : '; 
	...
	if($her == 2){//Foro
	echo'<h5>Descripción<h5/>';	
	echo'Espacio para intercambiar ideas, crear debates o discutir un tema entre  profesores y  alumnos.<br>';
	echo '<br>Incluir ' ;
  ...
  if($activity == 9){//Infografía
			...
			elseif($her == 3){//tarea
			echo'<h5>Descripción<h5/>';
		    echo'Entorno virtual en donde el alumno sube una infografía, ya sea como imagen o en el formato de origen .<br>';
			echo'<br>Incluir:';
 ...
 if($activity ==12){
	 if($her == 2){//foro
	     echo'<h5>Descripción<h5/>';
		 echo'Esta herramienta permite a los alumnos subir infografías y hacer comentarios sobre las infografías de sus compañeros de acuerdo a las instrucciones del docente.<br>';
         echo'<br>Incluir:';
		 echo'<br>1.Instrucciones de participación para el alumno';
		 echo'<br>2.Tema a discutir';	
	        }
	...
	if($activity == 14){
		if($her == 2){
		echo'<h5>Descripción<h5/>';
		echo'Espacio en donde el alumno, en forma de imagen comparte su díptico para poder comentar opiniones a sus compañeros.<br>';
        echo'<br>Incluir:';
		echo'<br>1.Instrucciones de participación para el alumno';
		echo'<br>2.Tema a discutir';	
		   }
	...
	if($activity == 15){
		if($her == 3){
		echo'<h5>Descripción<h5/>';
		echo'Espacio en  donde el alumno adjunta audios en formato MP3 y puede agregar un comentario para su profesor. <br>';
		echo'<br>Incluir:';
		echo'<br>1.Instrucciones de participación para el Alumno.';
		echo'<br>2.Retroalimentación general para los alumnos.';
		}
	...
	if($activity ==22){
		if($her ==3){
		echo'<h5>Descripción:</h5>';
		echo'Espacio en donde el alumno puede crear un cuadro comparativo, ya sea dentro de la plataforma (editor de texto) o mediante un archivo adjunto en cualquier formato. <br>';
		echo'<br>Incluir:';	
	    echo'<br>1.Instrucciones de participación para el Alumno.';
		echo'<br>2.Retroalimentación general para alumnos.';	
		  }
