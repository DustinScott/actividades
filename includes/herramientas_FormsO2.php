...
herramientas_id = ".$her."");
	...
	if($activity == 1){	
		...
		echo'Grupo de preguntas cuya respuesta debe seleccionarse de una serie de opciones. <br>';
	    echo '<br>Incluir : '; 
		...
		echo'<h5>Descripción<h5/>';
		echo 'Preguntas  cuya respuesta puede ser falsa o verdadera. <br>';
		echo '<br> Incluir :';
		...
		echo'<h5>Descripción<h5/>';
		echo'Preguntas donde respuesta especifica debe ser una sola  palabra.<br>';
		echo'<br> Incluir :';
		echo'<br>1.Contenido de cuestionario.';
		echo'<br>2.Número de pregunta. ';
		echo'<br>3.Texto de la pregunta.';
	...
	if($activity == 6){ //reseña//
		if($her == 3){ 
		echo'<h5>Descripción<h5/>';
		echo'Elalumno puede redactar su Reseña en un procesador de texto dentro de la plataforma o adjuntar un archivo en cualquier formato. <br>';
		echo '<br>Incluir : ';	
	    echo '<br>1.Instrucciones de participación para el Alumno.';
  ...
  if($activity == 9){//Infografía
	...
	//Empieza mapa mental//
	    if($activity == 10){
			...
			elseif($her == 3){ //tarea 
			echo '<h5>Descripción</h5>';
			echo'En este medio el alumno adujunta su mapa mental de dos maneras,ya sea convertido en imagen y/o archivo original.<br>';
			echo'<br>Incluir:';
			...
			echo '<h5>Descripción</h5>';
			echo'En este medio se coloca un mapa mental con algunos espacios en blanco, para que el alumno acomode la imaggen correcta de acuerdo al tema.<br>';
			echo'<br>Incluir:';
			echo'<br>1.Instrucciones para el Alumno';
			echo'<br>2.Retroalimentación para los alumnos';
			echo'<br>3.Imagen de como debe verse la actividad';
	 ...
	 if($activity ==11){
		 if($her ==2){//foro
		 echo'<h5>Descripción<h5/>';
		 echo'Espacio donde el alumno comparte un Mapa conceptual en formato de imagen, y sus compañeros la pueden calificar.<br>';
         echo'<br>Incluir:';
		 echo'<br>1.Instrucciones de participación para el alumno';
		 echo'<br>2.Tema a discutir';
		   }
		...
		elseif($her==9){//arrastrar texto sobre imagen
		echo'<h5>Descripción<h5/>';	
		echo'Actividad donde el alumno arrastray suelta el texto faltante de un mapa conceptual.<br>';
		echo'<br>Incluir:';
        echo'<br>1.Instrucciones para el alumno.';
		echo'<br>2.Retroalimentación general para alumnos.';
		echo'<br>3.imagen de como debe verse la actividad ';
 ...
 if($activity ==12){
	 if($her == 2){
        ...
        elseif($her == 3){
        echo'<h5>Descripción<h5/>';
		 echo'Con esta herramienta el alumno adjunta su linea del tiempo en el formato que sea y puede agregar un comentario para el docente.<br>';
		 echo'<br>Incluir:';
		 echo'<br>1.Instrucciones de participación para el Alumno.';
		 echo'<br>2.Retroalimentación general para los alumnos.';	
		    }
		elseif($her ==8){ //arrastrar imagen
		echo'<h5>Descripción<h5/>';
    	echo'Medio virtual en donde el Profesor coloca una linea del tiempo para que el alumno coloque las imágenes faltantes según corresponda.<br>';
	    echo'<br>Incluir:';
	    echo'<br>1.Instrucciones de participación para el alumno.';
	    echo'<br>2.Retroalimentación general para el alumno.';
		echo'<br>3.Imagen de como debe verse la actividad';
     ...
     if($activity == 13){
		if($her == 2){
		echo'<h5>Descripción<h5/>';
		 echo'Espacio virtual en donde el alumno, en forma de imagen comparte su tríptico para sí mismo poder comentar opiniones a sus compañeros e inversamente.<br>';
         echo'<br>Incluir:';
		 echo'<br>1.Instrucciones de participación para el alumno';
		 echo'<br>2.Tema a discutir';
		  }
		elseif($her == 3){
		echo'<h5>Descripción<h5/>';
		echo'Espacio en donde el alumno adjunta tripticos de dos maneras , yasea convirtiendo en una imagen o como archivo original y solo lo ve el profesor.<br>';
		echo'<br>Incluir:';
		echo'<br>1.Instrucciones de participación para el Alumno.';
		echo'<br>2.Retroalimentación general para los alumnos.';
		  }
	...
	if($activity ==16){
     if($her == 3){		
	echo'<h5>Descripción<h5/>';
		echo'Espaci donde el alumno adjunta un video,elaborado de acuerdo a las especificaciones del docente. <br>';
		echo'<br>Incluir:';
		echo'<br>1.Instrucciones de participación para el Alumno.';
		echo'<br>2.Retroalimentación general para los alumnos.';
	 }
     if($her == 2){
		echo'<h5>Descripción<h5/>';
		echo'Espacio  donde el alumno comparte un video elaborado con las especificaciones del docente,y todos sus compañeros del grupo lo pueden ver y comentar .<br>';
        echo'<br>Incluir:';
		echo'<br>1.Instrucciones de participación para el alumno';
		echo'<br>2.Tema a discutir';	
		}
	...
	if($activity == 20){
		if($her ==3){
		echo'Descripción:El alumno puede crear Tablas en un procesador de texto dentro de la plataforma o adjuntar un archivo en cualquier formato. <br>';
		echo'<br>Incluir : ';	
	    echo'<br>1.Instrucciones de participación para el Alumno.';
		echo'<br>2.Retroalimentación general para alumnos.';
	      }
	...
	if($activity == 23){
		...
		if($activity ==25){//ensayo
			if($her == 3){
			echo'<h5>Descripción</h5>';
			echo'Espacio en el que el alumno puede redactar un ensayo en un procesador de texto dentro de la plataforma.Tambien se utiliza para que el alumno adjunte un archivo en cualquier formato. <br>';
		    echo '<br>Incluir : ';	
	        echo '<br>1.Instrucciones de participación para el Alumno.';
		    echo '<br>2.Retroalimentación general para alumnos.';
		      }
